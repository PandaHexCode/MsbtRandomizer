...
namespace CLMS
{
    ...
    public abstract class LMSBase
    {
            ...
            get
            {
                switch (Header.EncodingType)
                {
                    ...
                    case EncodingType.UTF16:
                        if (Header.ByteOrder == Syroot.BinaryData.ByteOrder.BigEndian)
                        {
        ...
        public LMSBase(FileType aFileType, Syroot.BinaryData.ByteOrder aByteOrder = Syroot.BinaryData.ByteOrder.LittleEndian, byte aVersionNumber = 3)
        {
            Header = new();
        ...
        public LMSBase(Syroot.BinaryData.ByteOrder aByteOrder, Encoding aEncoding, bool createDefaultHeader, FileType aFileType, byte aVersionNumber = 3)
        {
            Header = new();
    ...
    */
    ...
    internal class Header
    {
        ...
        {
            bdr.ByteOrder = Syroot.BinaryData.ByteOrder.BigEndian;
            ...
            ByteOrder = (Syroot.BinaryData.ByteOrder)bdr.ReadUInt16();
        ...
        {
            bdw.ByteOrder = Syroot.BinaryData.ByteOrder.BigEndian;
            switch (FileType)
            {
                case FileType.MSBT:

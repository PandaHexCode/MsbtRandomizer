...
namespace CLMS
{
    public class WMBP : LMSBase
    {
        ...
        public WMBP(Syroot.BinaryData.ByteOrder aByteOrder, Encoding aEncoding, bool createDefaultHeader = true) : base(aByteOrder, aEncoding, createDefaultHeader, FileType.WMBP) { }

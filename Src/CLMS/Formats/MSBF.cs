...
namespace CLMS
{
    public class MSBF : LMSBase
    {
        ...
        public MSBF(Syroot.BinaryData.ByteOrder aByteOrder, Encoding aEncoding, bool createDefaultHeader = true) : base(aByteOrder, aEncoding, createDefaultHeader, FileType.MSBF) { }
